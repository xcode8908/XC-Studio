# XC Studio - Shared Project Context
...
XC Studio is an open-source, AI-orchestrated video production platform.
...
Layer 2: skills/                    → "How XC Studio uses them" (project conventions)
...
| `skills/core/hyperframes.md` | Layer 2 — when XC Studio should pick HyperFrames vs Remotion, artifact → workspace mapping |
