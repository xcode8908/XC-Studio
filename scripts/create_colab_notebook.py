    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "test_prompt = 'A serene cinematic lake at sunrise, gentle water ripples, mist rising, photorealistic, 4k'\n",
                "print(f\"🎬 Generating quick test video: '{test_prompt}'...\")\n",
                "\n",
                "result = generate_video(\n",
                "    prompt=test_prompt,\n",
                "    model_key='cogvideo-2b',  # Ultra-lightweight for fast testing\n",
                "    resolution='720x480',\n",
